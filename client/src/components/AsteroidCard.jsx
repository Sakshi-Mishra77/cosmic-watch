...
const AsteroidCard = ({ data }) => {
  ...
  return (
    <Card className={`group glass-card ${borderAccent} transition-all duration-200 min-w-0`}>
      <CardHeader className="flex flex-row items-center justify-between gap-2 sm:gap-3 space-y-0 p-4 sm:p-6 pb-3">
        <CardTitle className="font-heading text-base sm:text-lg font-bold truncate text-white min-w-0">
          {data.name.replace(/[()]/g, '')}
        </CardTitle>
      ...
      <CardContent className="pt-0 px-4 sm:px-6 pb-4 sm:pb-6">
        <div className="grid gap-3 sm:gap-4">
          <div className="flex items-center gap-2 sm:gap-3 rounded-xl border border-white/10 bg-white/[0.05] p-2.5 sm:p-3 group-hover:bg-white/[0.07] transition-colors min-w-0">
          ...
          <div className="grid grid-cols-2 gap-2 sm:gap-3 text-sm">
            <div className="rounded-lg border border-white/5 bg-white/[0.04] p-2.5 sm:p-3 hover:bg-white/[0.06] transition-colors min-w-0">
            ...
            <div className="col-span-2 rounded-lg border border-accent-purple/20 bg-accent-purple/10 p-2.5 sm:p-3 min-w-0">
              <span className="flex items-center gap-1.5 text-xs text-gray-500">
